...
-------
## 目标
让肥胖人群可以通过这个APP了解自身的身体状况以及每天的食品摄入热量，并根据测出其身体情况给出相应的饮食、运动、生活方式的干预指导。
...
### 核心价值与用户痛点
- 传统的健康管理类软件需要手动输入每天的卡路里摄入量，操作繁杂且热量统计不准确，并无法根据摄入热量推荐合理的运动量，导致用户的运动消耗和饮食摄入的热量不均衡，不利于用户知道其每天的运动量，为之后的减肥做准备。
